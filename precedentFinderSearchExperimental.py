...
response = client.chat.completions.create(
  ...
  messages=[{"role": "user", 
             "content": "Based on the Given court opinion(ignore the HTML format), [" + bigArrayTest[0] + "], Use the most relevant inputted case information to write a one-sentence strategy that the winning lawyer used so that a new lawyer can mimic it"}])
